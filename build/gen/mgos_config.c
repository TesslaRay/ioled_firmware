...
const struct mgos_conf_entry mgos_config_schema_[244] = {
  ...
  {.type = CONF_TYPE_OBJECT, .key = "board", .offset = offsetof(struct mgos_config, board), .num_desc = 44},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "led3", .offset = offsetof(struct mgos_config, board.led3), .num_desc = 5},
  ...
  {.type = CONF_TYPE_DOUBLE, .key = "duty", .offset = offsetof(struct mgos_config, board.led3.duty)},
  {.type = CONF_TYPE_INT, .key = "freq", .offset = offsetof(struct mgos_config, board.led3.freq)},
  {.type = CONF_TYPE_BOOL, .key = "state", .offset = offsetof(struct mgos_config, board.led3.state)},
  {.type = CONF_TYPE_OBJECT, .key = "btn1", .offset = offsetof(struct mgos_config, board.btn1), .num_desc = 3},
  ...
  {.type = CONF_TYPE_STRING, .key = "control", .offset = offsetof(struct mgos_config, board.btn1.control)},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "led4", .offset = offsetof(struct mgos_config, board.led4), .num_desc = 5},
  {.type = CONF_TYPE_BOOL, .key = "active_high", .offset = offsetof(struct mgos_config, board.led4.active_high)},
  {.type = CONF_TYPE_DOUBLE, .key = "duty", .offset = offsetof(struct mgos_config, board.led4.duty)},
  {.type = CONF_TYPE_INT, .key = "freq", .offset = offsetof(struct mgos_config, board.led4.freq)},
  {.type = CONF_TYPE_INT, .key = "pin", .offset = offsetof(struct mgos_config, board.led4.pin)},
  {.type = CONF_TYPE_BOOL, .key = "state", .offset = offsetof(struct mgos_config, board.led4.state)},
  {.type = CONF_TYPE_OBJECT, .key = "led5", .offset = offsetof(struct mgos_config, board.led5), .num_desc = 5},
  {.type = CONF_TYPE_BOOL, .key = "active_high", .offset = offsetof(struct mgos_config, board.led5.active_high)},
  {.type = CONF_TYPE_DOUBLE, .key = "duty", .offset = offsetof(struct mgos_config, board.led5.duty)},
  {.type = CONF_TYPE_INT, .key = "freq", .offset = offsetof(struct mgos_config, board.led5.freq)},
  {.type = CONF_TYPE_INT, .key = "pin", .offset = offsetof(struct mgos_config, board.led5.pin)},
  {.type = CONF_TYPE_BOOL, .key = "state", .offset = offsetof(struct mgos_config, board.led5.state)},
  {.type = CONF_TYPE_OBJECT, .key = "neopixel", .offset = offsetof(struct mgos_config, board.neopixel), .num_desc = 3},
...
/* board.led1.duty */
#define MGOS_CONFIG_HAVE_BOARD_LED1_DUTY
#define MGOS_SYS_CONFIG_HAVE_BOARD_LED1_DUTY
double mgos_config_get_board_led1_duty(struct mgos_config *cfg) {
  return cfg->board.led1.duty;
}
void mgos_config_set_board_led1_duty(struct mgos_config *cfg, double v) {
  cfg->board.led1.duty = v;
}

/* board.led1.freq */
#define MGOS_CONFIG_HAVE_BOARD_LED1_FREQ
#define MGOS_SYS_CONFIG_HAVE_BOARD_LED1_FREQ
int mgos_config_get_board_led1_freq(struct mgos_config *cfg) {
  return cfg->board.led1.freq;
}
void mgos_config_set_board_led1_freq(struct mgos_config *cfg, int v) {
  cfg->board.led1.freq = v;
}

/* board.led1.state */
#define MGOS_CONFIG_HAVE_BOARD_LED1_STATE
#define MGOS_SYS_CONFIG_HAVE_BOARD_LED1_STATE
int mgos_config_get_board_led1_state(struct mgos_config *cfg) {
  return cfg->board.led1.state;
}
void mgos_config_set_board_led1_state(struct mgos_config *cfg, int v) {
  cfg->board.led1.state = v;
}
...
/* board.btn1.control */
#define MGOS_CONFIG_HAVE_BOARD_BTN1_CONTROL
#define MGOS_SYS_CONFIG_HAVE_BOARD_BTN1_CONTROL
const char * mgos_config_get_board_btn1_control(struct mgos_config *cfg) {
  return cfg->board.btn1.control;
}
void mgos_config_set_board_btn1_control(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->board.btn1.control, v);
}
...
int mgos_config_get_board_led5_state(struct mgos_config *cfg) {
  return cfg->board.led5.state;
}
void mgos_config_set_board_led5_state(struct mgos_config *cfg, int v) {
  cfg->board.led5.state = v;
}

/* board.neopixel */
#define MGOS_CONFIG_HAVE_BOARD_NEOPIXEL
#define MGOS_SYS_CONFIG_HAVE_BOARD_NEOPIXEL
const struct mgos_config_board_neopixel * mgos_config_get_board_neopixel(struct mgos_config *cfg) {
  return &cfg->board.neopixel;
}

/* board.neopixel.state */
#define MGOS_CONFIG_HAVE_BOARD_NEOPIXEL_STATE
#define MGOS_SYS_CONFIG_HAVE_BOARD_NEOPIXEL_STATE
int mgos_config_get_board_neopixel_state(struct mgos_config *cfg) {
  return cfg->board.neopixel.state;
}
void mgos_config_set_board_neopixel_state(struct mgos_config *cfg, int v) {
  cfg->board.neopixel.state = v;
}

/* board.neopixel.pin */
#define MGOS_CONFIG_HAVE_BOARD_NEOPIXEL_PIN
#define MGOS_SYS_CONFIG_HAVE_BOARD_NEOPIXEL_PIN
int mgos_config_get_board_neopixel_pin(struct mgos_config *cfg) {
  return cfg->board.neopixel.pin;
}
void mgos_config_set_board_neopixel_pin(struct mgos_config *cfg, int v) {
  cfg->board.neopixel.pin = v;
}

/* board.neopixel.pixels */
#define MGOS_CONFIG_HAVE_BOARD_NEOPIXEL_PIXELS
#define MGOS_SYS_CONFIG_HAVE_BOARD_NEOPIXEL_PIXELS
int mgos_config_get_board_neopixel_pixels(struct mgos_config *cfg) {
  return cfg->board.neopixel.pixels;
}
